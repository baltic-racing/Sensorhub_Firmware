...
#define POT_MIN 12	//adc value for full steering lock right
#define POT_MAX 720	//adc value for full steering lock left
#define POT_MID 346	//adc value for middle position
