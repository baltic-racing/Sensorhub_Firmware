...
#define POT_MIN	108	//adc value for full steering lock right
#define POT_MAX 877	//adc value for full steering lock left
#define POT_MID 487	//adc value for middle position
